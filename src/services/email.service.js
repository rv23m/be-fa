        ...
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #1a1a1a; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            <h2 style="color: #ffffff; font-size: 28px; font-weight: 600; margin: 0 0 20px; text-align: center;">Reset your password</h2>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 30px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="${resetUrl}" style="display: inline-block; background-color: #7b7bf7; color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-size: 16px; font-weight: 600; text-align: center;">
                                            Set My Password
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="padding: 40px; text-align: center; border-top: 1px solid #333333;">
                            ...
                            <p style="color: #7b7bf7; font-size: 14px; line-height: 1.6; margin: 0;">
                                <a href="mailto:support@hellodail.com" style="color: #7b7bf7; text-decoration: none;">support@hellodail.com</a>
                            </p>
                            
                            <p style="color: #666666; font-size: 12px; line-height: 1.6; margin: 30px 0 0;">
                                An AI Sales Coaching roleplaying platform designed to train, diagnose, and inspire.
                            </p>
